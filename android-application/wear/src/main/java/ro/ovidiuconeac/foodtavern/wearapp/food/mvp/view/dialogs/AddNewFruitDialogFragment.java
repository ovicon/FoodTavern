...
public final class AddNewFruitDialogFragment extends DialogFragment {
    ...
    public static AddNewFruitDialogFragment newInstance(FoodView view) {
        AddNewFruitDialogFragment.view = view;
        return new AddNewFruitDialogFragment();
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_dialog_add_new_fruit, container, false);
